...
export default function WeightChart({ data, goalWeight, currentWeight }: WeightChartProps) {
  ...
  // Buscar el punto más cercano al objetivo
  const trophyIndex = chartData.findIndex(d => Math.abs(d.weight - goalWeight) < 0.01);
  ...
  // Definir el SVG del trofeo como un componente inline para usarlo en la etiqueta
  const TrophyInline = (
    <svg width="18" height="18" viewBox="0 0 56 56" style={{ display: 'inline', verticalAlign: 'middle', marginRight: 4 }}>
